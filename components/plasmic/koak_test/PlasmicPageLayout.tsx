...
// Plasmic Project: vZME8dHU2Xotr7u7WHB28W
// Component: S55i-UjqIHEs
...
import projectcss from "./plasmic.module.css"; // plasmic-import: vZME8dHU2Xotr7u7WHB28W/projectcss
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: S55i-UjqIHEs/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: -k5qMEVLOAkv/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: j2SyWuVCPmzD/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__qzJoW)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__u0M05)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__ogiN2)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__t4Eg6)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section___5UJhZ)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
